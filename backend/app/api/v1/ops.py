...
async def metrics():
    ...
    Public (like /health and /ready): scraped unauthenticated by the
    in-cluster Prometheus (see prometheus.yml). Contains only aggregate
    counters/histograms — no PII or credentials.
    """
