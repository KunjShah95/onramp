        ...
        for root, dirs, files in os.walk(repo_path):
            ...
            for fname in files:
                ...
                try:
                    ...
                    # Convert absolute path to relative path for files and fields in result
        ...
        for line in content.split("\n"):
            ...
            if m:
                ...
                if "class" in stripped:
                    analysis.classes.append({"name": name, "methods": [], "lineno": 0})
                else:
                    analysis.functions.append({"name": name, "args": [], "lineno": 0})
