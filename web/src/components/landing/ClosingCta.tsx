  ...
  return (
    <section className="relative overflow-hidden border-t border-white/5 bg-panel">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-1/2 h-[360px] w-[720px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#00D9FF]/10 blur-[120px]" />
        <div className="absolute right-10 top-0 h-[220px] w-[320px] rounded-full bg-[#10B981]/10 blur-[100px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-[1280px] px-6 py-24 lg:px-10 lg:py-32">
        ...
        >
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
            ...
            <Link
              to="/pricing"
              className="inline-flex h-12 items-center rounded-sm border border-white/10 bg-panel-raised px-7 text-[15px] font-semibold text-white transition-all hover:border-[#00D9FF]/40 active:translate-y-px"
            >
              See pricing
            </Link>
          </div>
