  ...
  return (
    <div className={`landing-premium${lightClass} min-h-screen flex flex-col lg:flex-row bg-room text-ink antialiased font-body`}>
      ...
      <div className="relative hidden lg:flex lg:w-[46%] xl:w-[44%] shrink-0 flex-col justify-between overflow-hidden border-r border-seam bg-panel-raised">
        ...
        <div aria-hidden className="pointer-events-none absolute inset-0">
          ...
          <div
            ...
            style={{
              backgroundImage: 'radial-gradient(rgb(var(--border-rgb) / 0.08) 1px, transparent 1px)',
        ...
        <div className="relative z-10 flex flex-col gap-10 p-10 xl:p-12">
          <Link to="/" className="group inline-flex items-center gap-2.5 self-start" aria-label="Onramp home">
            <span className="flex h-9 w-9 items-center justify-center rounded-card bg-gradient-to-br from-accent-primary via-accent-via to-accent-to text-white shadow-seam transition-transform duration-200 group-hover:scale-[1.03]">
          ...
          <div className="mt-6 max-w-[420px]">
            <p className="inline-flex items-center gap-2 rounded-full border border-seam bg-panel px-3 py-1.5 shadow-seam">
          ...
          <div className="mt-2 grid grid-cols-1 gap-3 max-w-[380px]">
            {[
              ...
              <div key={r.label} className="flex items-center gap-3 rounded-card border border-seam bg-panel px-4 py-3 shadow-seam">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg border border-seam bg-panel text-ink-tertiary">
                  <r.icon size={15} weight="bold" />
                </span>
                <div className="min-w-0">
                  <div className="text-[13px] font-semibold text-ink leading-none">{r.label}</div>
                  <div className="font-code text-[11px] text-ink-secondary">{r.meta}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="flex flex-1 flex-col bg-room">
        {/* mobile brand bar */}
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-seam bg-room px-6 lg:hidden">
        ...
        <main className="flex flex-1 items-center justify-center p-6 sm:p-8 lg:p-10">
          <div className="w-full max-w-[420px]">
            ...
            <div className={cn('rounded-card border border-seam bg-panel p-7 shadow-seam sm:p-8')}>
              <div className="mb-7">
            ...
            <p className="mt-4 text-center font-code text-[11px] text-ink-secondary">
              Protected by Onramp · <Link to="/privacy" className="underline decoration-seam underline-offset-4 hover:text-ink">Privacy</Link> · <Link to="/terms" className="underline decoration-seam underline-offset-4 hover:text-ink">Terms</Link>
            </p>
          </div>
        </main>
      </div>
