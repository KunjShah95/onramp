      ...
      <div className="relative hidden lg:flex lg:w-[46%] xl:w-[44%] shrink-0 flex-col justify-between overflow-hidden border-r border-seam bg-panel-raised">
        <div className="relative z-10 flex flex-col gap-10 p-10 xl:p-12">
          ...
          <div className="mt-6 max-w-[420px]">
            <p className="inline-flex items-center gap-2 rounded-full border border-seam bg-panel px-3 py-1.5">
              <span className={`h-1.5 w-1.5 rounded-full ${dot}`} />
              <span className="font-code text-[10px] font-medium uppercase tracking-[0.14em] text-ink-secondary">{rail} · {designator}</span>
            </p>
            <h2 className="mt-6 text-[26px] font-semibold leading-[1.12] tracking-[-0.02em] text-ink">
              Where code becomes a map.
            </h2>
          ...
          <div className="mt-2 grid grid-cols-1 gap-3 max-w-[380px]">
            {[
              ...
              <div key={r.label} className="flex items-center gap-3 rounded-card border border-seam bg-panel px-4 py-3">
      ...
      <div className="flex flex-1 flex-col bg-room">
        ...
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-seam bg-room px-6 lg:hidden">
          <Link to="/" className="inline-flex items-center gap-2.5" aria-label="Onramp home">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-go text-white">
              <TreeStructure size={16} weight="bold" />
            </span>
