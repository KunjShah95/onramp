...
export default function Sidebar() {
  ...
  return (
    <aside
      ...
      className={cn(
        'sticky top-0 app-sidebar self-start bg-bg-primary border-r border-border/50 flex flex-col shrink-0 transition-[width] duration-200 ease-out overflow-hidden',
