...
const articleContent: Record<string, string[]> = {
  'onboarding-hidden-tax-engineering-velocity': [
    ...
    'The outcome hypothesis is simple: make repository context available at the moment of need, then measure whether new hires reach a safe first contribution sooner and seniors spend less time repeating explanations. We are validating that hypothesis with a small design-partner cohort rather than publishing unmeasured outcome claims.',
  ...
  'how-we-built-codebase-aware-ai-mentor': [
    ...
    'A critical design decision was privacy. We process source code to build the indexed graph and remove the temporary checkout after indexing. Derived repository documents and embeddings remain available to authorized workspace members so answers can cite the code that was indexed; retention and deletion controls are being expanded.',
