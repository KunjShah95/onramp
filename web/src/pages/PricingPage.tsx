  ...
  return (
    <div className="min-h-screen bg-[#110D0A] text-[#FDFBF8] font-body selection:bg-accent-from/30">
      ...
      <div className="pt-24 pb-16 px-6 text-center max-w-3xl mx-auto">
        <h1 className="font-display text-4xl md:text-5xl font-bold tracking-tight mb-6">Standardized pricing for <span className="text-accent-from">engineering teams</span></h1>
      ...
      {/* Pricing Cards */}
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6 pb-24">
        {/* Free */}
        <div className="bg-[#1A1512] rounded-2xl p-8 border border-[#FDFBF8]/5 flex flex-col hover:border-accent-from/30 transition-colors">
        ...
        {/* Startup */}
        <div className="bg-gradient-to-b from-[#1f1915] to-[#1A1512] rounded-2xl p-8 border border-accent-from/40 flex flex-col relative shadow-[0_0_40px_rgba(255,140,0,0.1)]">
