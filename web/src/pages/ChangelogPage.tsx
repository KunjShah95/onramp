    ...
    <div className="min-h-screen bg-[#050505] text-[#FDFBF8] font-body">
      ...
      <div className="max-w-2xl mx-auto px-6 pt-40 pb-32">
        ...
        <div className="mb-16">
          ...
          <h1 className="font-display text-4xl font-bold tracking-tight mb-4">What's new in CodeFlow</h1>
        ...
        <div className="space-y-16">
          {entries.map((entry) => (
            <div key={entry.version} className="relative pl-8 border-l border-[#FDFBF8]/6">
              {/* Dot */}
