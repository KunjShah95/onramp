              ...
              <div className="pl-3.5 border-l border-seam/30 text-body-sm text-ink-muted/50 leading-[1.8] space-y-3 max-w-none">
                {body.split('\n\n').map((p, j) => {
                  ...
                  if (isCode) {
                    ...
                    return (
                      <pre key={j} className="bg-well/60 border border-seam rounded-xl p-4 overflow-x-auto text-code-sm text-ink-muted/80 font-code leading-relaxed">
                        <code>{code}</code>
                      </pre>
                    )
                  }
                  ...
                  if (p.match(/^\d+\.\s/)) {
                    ...
                    return (
                      <ol key={j} className="space-y-1.5 list-decimal list-inside marker:text-ink-muted/30">
                        {items.map((item, k) => (
          ...
          <div className="relative group">
            <div className="flex items-center gap-2 bg-well border border-seam group-focus-within:border-go/40 rounded-card px-4 py-3 transition-colors">
              ...
              <input
                ...
                className="flex-1 bg-transparent text-body-sm text-ink placeholder:text-ink-muted/40 outline-none border-none font-code"
              />
              <button onClick={handlePaste}
                className="text-caption text-ink-muted/20 hover:text-ink-muted/60 px-2 py-1 rounded-lg hover:bg-well transition-all">
                Paste
              </button>
              ...
              <button
                ...
                className="flex items-center gap-2 bg-caution hover:bg-caution-lit text-[hsl(var(--primary-foreground))] px-4 py-2 rounded-btn text-body-xs font-semibold transition-all disabled:opacity-40 whitespace-nowrap">
            ...
            >
              ...
              <motion.div variants={item} className="mb-6">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-well border border-seam">
                    <Bug size={12} className="text-ink-muted/40" />
