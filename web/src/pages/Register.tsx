...
export default function Register() {
  ...
  const { register, registerWithGoogle, error, clearError, user } = useAuth()
      ...
      <div className="w-full max-w-sm z-10 relative">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-800 font-medium rounded-2xl py-3 px-4 text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_8px_32px_rgba(0,0,0,0.3)]"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-green-100/50">or</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
