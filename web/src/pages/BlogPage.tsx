  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6 pt-10 pb-24">
        {/* Header */}
        <div className="mb-12">
          <h1 className="font-body text-[clamp(2rem,4.2vw,2.9rem)] mb-3 font-bold tracking-[-0.02em] text-ink">
            Onramp Blog
          </h1>
        ...
        <div className="space-y-8">
          {posts.map((post) => (
            <Link key={post.slug} to={`/blog/${post.slug}`} className="block group">
              <article className="p-6 rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))]/30 transition-colors hover:border-[hsl(var(--accent))]/30 ">
        ...
        {/* Newsletter */}
        <div className="mt-12 p-8 rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))]/50 text-center">
