  ...
  theme: {
    extend: {
      colors: {
        ...
        go: { DEFAULT: '#0E7A3C', lit: '#17A34A' },
        mission: { DEFAULT: '#1A5FA8', lit: '#2472C4' },
        caution: { DEFAULT: '#B5710A', lit: '#D6870F' },
        abort: { DEFAULT: '#BE3A2E', lit: '#D24C3F' },
        seam: { DEFAULT: 'rgba(24,27,24,0.12)', strong: 'rgba(24,27,24,0.20)' },

        // ── Legacy semantic names (same palette) ──
        bg: {
          void: '#DDE1DD',
          primary: '#E4E7E3',
          secondary: '#F6F7F4',
        ...
        accent: {
          ...
          via: '#0B6A34',
          to: '#17A34A',
          muted: 'rgba(14,122,60,0.12)',
          glow: 'rgba(14,122,60,0.06)',
        },
        text: {
          primary: '#181B18',
          secondary: '#565B54',
        ...
        border: {
          subtle: 'rgba(24,27,24,0.06)',
          DEFAULT: 'rgba(24,27,24,0.12)',
          hover: 'rgba(24,27,24,0.20)',
          active: 'rgba(24,27,24,0.28)',
          accent: 'rgba(14,122,60,0.35)',
        },
        success: { DEFAULT: '#0E7A3C', lit: '#17A34A', muted: 'rgba(14,122,60,0.12)' },
        warning: { DEFAULT: '#B5710A', lit: '#D6870F', muted: 'rgba(181,113,10,0.12)' },
        error: { DEFAULT: '#BE3A2E', lit: '#D24C3F', muted: 'rgba(190,58,46,0.12)' },
        info: { DEFAULT: '#1A5FA8', lit: '#2472C4', muted: 'rgba(26,95,168,0.12)' },
        nx: {
